...
<title>@yield('title') Modelo</title>
    ...
    <div class="container-fluid" style="margin-top: 18%">
        <div class="p-3" style="background: rgb(255, 253, 253); border-radius: 20px;">
            <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <h2 style="color: black; margin-left: 33%;">Gestión de la Modelo</h2>
            ...
            <div class="">
                <table id="modelos" class="table text-start align-middle table-bordered table-hover mb-0">
                    <thead>
                        <tr class="text-white">
                    ...
                    <tbody>
                        ...
                        @foreach ($modelos as $modelo)
                                <tr>
                                    <!-- <td style="color: black;">{{ $modelo->id}}</td> -->
                                    <td class="col-10" style="color: black;">{{ $modelo->nombre_modelo }}</td>
