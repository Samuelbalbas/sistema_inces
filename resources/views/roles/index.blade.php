    ...
    <div class="container-fluid" style="margin-top: 2.5%">
        <div class="p-3" style="background: rgb(240, 236, 236); border-radius: 20px;">
            <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <h2 style="color: black; margin-left: 33%;">Gestión de los Roles</h2>
            ...
            <div class="">
                <table id="roles" class="table text-start align-middle table-bordered table-hover mb-0">
                    <thead>
                        <tr class="text-white">
                    ...
                    <tbody>
                        ...
                        @foreach ($roles as $role)
                                <tr>
                                    ...
                                    <td class="col-10" style="color: black;">{{ $role->name }}</td>
                                
                                    <td>
                                        @can('editar-rol')
                                            <a class="btn btn-warning" style="margin-left: 20%;" href="{{ route('roles.edit',$role->id) }}"><i class="bi bi-pencil-square"></i></a>
                                        @endcan

                                        @can('borrar-rol')
                                            <form action="{{ route('roles.destroy', $role->id) }}" method="POST" class="sweetalert" style="display:inline;">
                                                @csrf
                                                {{ method_field('DELETE') }}
